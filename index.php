<?php get_header(); ?>
         ...
         <!-- Five -->
        <section id="five" class="wrapper style2 special fade" style="height:700px!important;padding-top:12em;">
          <div class="container">
            <header>
              <h2>School Leaving Certifiate (SLC) Result 2071 / 2072</h2>
              <p>Enter your SLC Symbol No.</p>
            </header>
            <form method="post" action="#" class="container 50%">
              <div class="row uniform 50%">
                <div class="8u 12u$(xsmall)"><input type="text" name="symbol" id="symbol" placeholder="Your Symbol No." /></div>
                <div class="4u$ 12u$(xsmall)"><input type="submit" value="Get Result" class="fit special" /></div>
              </div>
            </form>
          </div>
        </section>
      ...
      <!-- Banner 
        <section id="banner">
          <div class="content">
            ...
            <span class="image"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/pic01.jpg" alt="" /></span>
          </div>
      ...
      <!-- Two 
        <section id="two" class="spotlight style2 right">
          <span class="image fit main"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/pic03.jpg" alt="" /></span>
          <div class="content">
            <header>
      ...
      <!-- Footer -->
        <footer id="footer">
          ...
          <ul class="copyright">
            <li>&copy; 2071-2071 SLC Result.All right Reserved.</li><li>Design: <a href="http://merobox.com">Mero Box</a></li>
          </ul>
        </footer>
...
echo $table->insert( array('id' => 2, 'name' => 'Ram') );
